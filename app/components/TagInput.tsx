  ...
  return (
    <div className="flex flex-wrap gap-2 mb-2">
      ...
      <input
        ...
        className="w-full md:w-1/2 lg:w-1/2 py-2 px-3 rounded-md text-md border-none outline-none text-right ml-auto border-b-2 border-gray-200 hover:border-gray-400 transition-colors"
      />
    </div>
  );
}
